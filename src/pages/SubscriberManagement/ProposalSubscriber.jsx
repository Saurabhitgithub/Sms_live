...
import SubscriberProposalPreveiw from "./SubscriberProposalPreveiw";

export default function ProposalSubscriber({ planData, inventoryPermission, servicesPermission }) {
