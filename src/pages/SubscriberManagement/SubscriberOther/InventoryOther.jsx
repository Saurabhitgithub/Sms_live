...
export default function InventoryOther({ planData,
  setOpen,
  toggleTab,
 }) {
      ...
      <div className="mt-md-5 mt-sm-4 mt-3">
        ...
        <div className="w-100 d-flex justify-content-end mt-4 p-0">
          ...
          <div className="w-100 d-flex justify-content-end mt-4 p-1">
            ...
            <button type="button" className="btn mr-2" onClick={() => toggleTab("1")} >
              Back
            </button>
            <button type="submit" className="btn btn-primary"  onClick={() => toggleTab("3")}>
              Next
            </button> */}
          </div>
